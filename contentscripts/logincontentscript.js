chrome.runtime.sendMessage({ message: "online.vfsglobal.dz-login" }, function (response) {
  //s
...
async function loginPage(){
  ...
  customselector("#g-recaptcha-response").style.display = "block";

  await waitFor(7000);

  //click on the checkbox
  //_x(`//*[@id="recaptcha-anchor"]/div[1]`).click();

  await waitFor(7000);
  
  //click submit at the end
  customselector("#ApplicantListForm > div.frm-button > input").click();  
}
